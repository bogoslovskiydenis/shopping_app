...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
        ...
        productColours:
            List<dynamic>.from(json["productColours"].map((x) => x)),
        productFabrics:
            List<dynamic>.from(json["productFabrics"].map((x) => x)),
        productImages: List<ProductImage>.from(
            json["productImages"].map((x) => ProductImage.fromJson(x))),
        productJacketModels:
            List<dynamic>.from(json["productJacketModels"].map((x) => x)),
        productPatterns:
            List<dynamic>.from(json["productPatterns"].map((x) => x)),
        productSizes: List<ProductSize>.from(
            json["productSizes"].map((x) => ProductSize.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "productJacketModels":
            List<dynamic>.from(productJacketModels!.map((x) => x)),
